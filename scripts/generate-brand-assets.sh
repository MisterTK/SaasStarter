...
for size in 16 32 64 128 256 512; do
    convert -density 512 -background "#F8F9FA" static/favicon.svg -resize ${size}x${size} static/images/brand/icon-${size}.png
done

# Generate Apple Touch Icons
echo "Generating Apple touch icons..."
convert -density 512 -background "#F8F9FA" static/favicon.svg -resize 180x180 static/apple-touch-icon.png

# Generate social media assets
echo "Generating social media assets..."

# Open Graph image (1200x630)
convert -size 1200x630 xc:"#F8F9FA" \
...
convert -size 1500x500 xc:"#1A2A4F" \
...
echo ""
echo "Note: You may need to install the Lora and Inter fonts for text rendering."