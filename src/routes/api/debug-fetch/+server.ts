...
export const GET: RequestHandler = async ({ url, fetch }) => {
	...
	try {
		const googleUrlObj = new URL('https://mybusiness.googleapis.com/v4/accounts');
	...
	try {
		const urlWithParams = new URL('https://mybusiness.googleapis.com/v4/accounts');
	...
	const fetchType = {
		...
		globalFetch: globalThis.fetch ? globalThis.fetch.toString() : 'not available',
