...
<div class="container mx-auto p-8 max-w-4xl">
	...
	<div class="alert alert-warning mb-6">
		...
		<div>
			...
			<div class="text-sm">This page is for testing Google My Business API connectivity. Only accessible in development or by admins.</div>
		</div>
	</div>
	...
	<form method="POST" action="?/testApi" class="space-y-4">
		<div class="form-control">
			...
			/>
			<label class="label">
				<span class="label-text-alt">Enter the Google My Business account ID (format: accounts/XXXXXXXXX)</span>
			</label>
		</div>
		...
		<div class="form-control">
			...
			/>
			<label class="label">
				<span class="label-text-alt">Enter the location ID (format: locations/XXXXXXXXX)</span>
			</label>
		</div>
					...
					<div class="card bg-base-100 shadow-xl mb-4">
						<div class="card-body">
							...
							<div class="overflow-x-auto">
								<pre class="text-xs bg-base-200 p-4 rounded"><code>{JSON.stringify(result, null, 2)}</code></pre>
							</div>
						</div>
					</div>
				{/each}
	...
	<div class="mt-8 prose">
		<h2>Instructions</h2>
		<ol>
			<li>Make sure you have connected your Google account in the Integrations page</li>
			<li>Get your Account ID and Location ID from the Google My Business dashboard or API</li>
			<li>Enter both IDs in the form above and click "Test API Connection"</li>
			<li>The test will try different methods to connect to the Google My Business API</li>
		</ol>
