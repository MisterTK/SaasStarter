<script lang="ts">
  ...
  const sizes = {
    sm: { container: 'w-8 h-8', square: 'w-6 h-6', text: 'text-sm' },
    md: { container: 'w-10 h-10', square: 'w-8 h-8', text: 'text-lg' },
    lg: { container: 'w-12 h-12', square: 'w-10 h-10', text: 'text-xl' }
  };
